...
rg.controller.info.InfoMap.fromTemplate = function(t) {
	...
	case "world":case "world-countries":
		return [{ field : "projection", value : "mercator"},{ field : "url", value : "geo/json/" + "world-countries.json"}];
	case "usa-states":
		return [{ field : "projection", value : "albersusa"},{ field : "url", value : "geo/json/" + "usa-states.json"}];
	case "usa-state-centroids":
		return [{ field : "projection", value : "albersusa"},{ field : "url", value : "geo/json/" + "usa-state-centroids.json"}];
	case "usa-counties":
		return [{ field : "projection", value : "albersusa"},{ field : "url", value : "geo/json/" + "usa-counties.json"}];
	default:
		return (function($this) {
			var $r;
			throw new thx.error.Error("invalid template",null,null,{ fileName : "InfoMap.hx", lineNumber : 174, className : "rg.controller.info.InfoMap", methodName : "fromTemplate"});
			return $r;
		}(this));
	}
}
...
rg.controller.info.InfoMap.GEOGSON_BASE_URL = "geo/json/";
